      ...
      <div className="homeContent-wrapper">
        ...
        <div className="pHome">
          <div className="pHome-text">
            <p>
              <span className="headings">Welcome, Riddlers!</span>
              <br /> Create a username and password to embark on a
              riddle-solving journey and see how well you do overall.
            </p>
            <p>
            ...
            <p id="last-p">
              ...
              without a hint awards 2 points. Solving a riddle with a hint
              awards 1 point. Regardless of success, please enjoy the process
              and comfort in knowing you are exercising your brain!
            </p>
          </div>
        </div>
      </div>
